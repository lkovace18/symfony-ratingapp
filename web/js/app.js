...
var _vueForRange = __webpack_require__(12);

var _vueForRange2 = _interopRequireDefault(_vueForRange);
...
_vue2.default.use(_vueForRange2.default);
_vue2.default.use(VueCookie);

_vue2.default.component('rating', __webpack_require__(13));
...
exports.default = {
  ...
  methods: {
    ...
    getRating: function getRating() {
      ...
      this.$http.post('http://iways.demo.dev/api/rating', data).then(function (response) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('fieldset', _vm._l((_vm.range(1, 11)), function(i) {
    return _c('div', {
      staticClass: "star",
      class: {
